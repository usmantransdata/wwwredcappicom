...
<?php } ?>
  <div id="body-dashborad" class="nobackground">
    <div class="container">
      <h1>Stats</h1>
	   <div class="info"><span>Are your open rates not where you want them? Your emails may be going to the SPAM folder. Make sure you use our Deliverability Scoring Button on the campaign scheduling page to see if there are any issues with your message. Also, please request SPF and DKIM setup to increase deliverability, more and more email providers are using this authentication to allow emails to come to the inbox. Please go to Extras menu on the top of the page and Request DKIM and SPF. If you have DKIM and SPF setup and your emails are still going to spam, please <a href="https://getredcappi.com/customer-support/" target="_blank">contact us</a></span></div>
      <?php if(count($emailreport_data)>0){ ?>
      <?php foreach($emailreport_data as $key=>$email){ ?>
        <table class="report">

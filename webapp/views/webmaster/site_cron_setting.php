...
<fieldset style='width:60%'><legend>Send Campaign Cron:</legend>
	...
	<label style='display:inline-block;width:40%; border:0px solid #ccc;'>Send-campaign status:</label> ".form_dropdown('cronjob_status',array('completed'=>'Completed','working'=>'Working'),$cronjob_status, "id='cronjob_status'")." &nbsp; <a href='javascript:void(0);' onclick='javascript:saveIt(\"cronjob_status\");' >Update</a><br/><span style='color:red; font-size:9px;'>".date('F j, Y \a\t g:i a', strtotime( getGMTToLocalTime($campaign_cron_status_change_time, date_default_timezone_get() )))."</span><br/><span style='color:#999; font-size:10px; text-decoration:italics;'>(Default is Active (working). To stop change to \"Stop\")</span></br>
                 ...
                 <label style='display:inline-block;width:40%; border:0px solid #ccc;'>Campaign In Progress:</label>$campaign_under_progress
...
echo "<tr><td valign='top' colspan='2'>
<fieldset style='width:60%'><legend>Send Campaign Cron 2:</legend>
    
	<label style='display:inline-block;width:40%; border:0px solid #ccc;'>Stop/Continue send-campaign-cronjob 2:</label> ".form_dropdown('continue_campaign_send',array('1'=>'Active','0'=>'Stop'),$continue_campaign_send, "id='continue_campaign_send'")." &nbsp; <a href='javascript:void(0);' onclick='javascript:saveIt(\"continue_campaign_send\");' >Update</a><br/><span style='color:#999; font-size:10px; text-decoration:italics;'> (Default is Active (working). To stop change to \"Stop\")</span>
	
	<hr style='border-top: dotted 1px;' />
	
	<label style='display:inline-block;width:40%; border:0px solid #ccc;'>Send-campaign status 2:</label> ".form_dropdown('cronjob_status',array('completed'=>'Completed','working'=>'Working'),$cronjob_status_2, "id='cronjob_status_2'")." &nbsp; <a href='javascript:void(0);' onclick='javascript:saveIt(\"cronjob_status_2\");' >Update</a><br/><span style='color:red; font-size:9px;'>".date('F j, Y \a\t g:i a', strtotime( getGMTToLocalTime($campaign_cron_status_change_time_2, date_default_timezone_get() )))."</span><br/><span style='color:#999; font-size:10px; text-decoration:italics;'>(Default is Active (working). To stop change to \"Stop\")</span></br>
            
                 <label style='display:inline-block;width:40%; border:0px solid #ccc;'>Campaign In Progress:</label>$campaign_under_progress_2
...
echo "<tr><td valign='top' width='40%'>Contact Import Progress<br/>
<span style='color:#999; font-size:10px; text-decoration:italics;'>(Default is Active (working). To stop change to \"Stop\")</span></td><td>"; 
echo "<p>";
if ($continue_bg_process_batch == 1)
        {
            echo "Stopped";
        }
        else
...
echo "<tr><td valign='top' width='40%'>Contact Analysis Progress<br/>
<span style='color:#999; font-size:10px; text-decoration:italics;'>(Default is Active (working). To stop change to \"Stop\")</span></td><td>"; 
echo "<p>$contact_analysis_cron_status</br>";
echo  "<span style='color:red; font-size:9px;'>" . date('F j, Y \a\t g:i a', strtotime( getGMTToLocalTime($queueing_start_date, date_default_timezone_get() ))) . "</span";
echo '</td></tr>';

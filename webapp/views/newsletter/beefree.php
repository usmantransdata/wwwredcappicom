  ...
  <body>
   ...
   <div id="diyy-header">
            ...
            <form action="" method="post">
				...
				-->
				<input type="button" name="next_step" class="btn add  save_next" value="Next Step" id='next_step'/>     
      ...
      onSave: function (jsonFile, htmlFile) { 
		...
		var postdata = {};
            ...
            postdata['campaign_title'] = title;
			 ...
			 jQuery.post('<?php echo base_url() ?>newsletter/campaign/beefreesave/', postdata, function (result) {
    ...
    request(
      ...
      function(token) {
        BeePlugin.create(token, beeConfig, function(beePluginInstance) {
          ...
          request(
            'GET', 
                   ...
                   '<?php echo base_url() ?>newsletter/campaign/fetchresponsive?id=<?php echo $campaign_id;?>',
	   ...
	   jQuery('#next_step').click(function () {
		   ...
		   jQuery('.redirectlink').val('<?php echo base_url() ?>newsletter/campaign_email_setting/index/<?php echo $campaign_id;?>');
           bee.save();
        });
		...
		/* jQuery('.preview').click(function () {
			...
			jQuery('.redirectlink').val('<?php echo base_url() ?>newsletter/campaign/responsiveview/<?php echo $campaign_id;?>');
            bee.save();
		...
		$(".save_campaign_changes").live('click',function(){
			jQuery('.redirectlink').attr('data-info', '');
			jQuery('.redirectlink').attr('data-info', 'false');
			//alert(jQuery('.redirectlink').attr('data-info'));
			jQuery('.redirectlink').val('<?php echo base_url() ?>newsletter/campaign/responsiveview/<?php echo $campaign_id;?>');
		...
		$(".discard_campaign_changes").live('click',function(){
			window.open('<?php echo base_url() ?>newsletter/campaign/responsiveview/<?php echo $campaign_id;?>', '_blank');           
			$.fancybox.close();
		});
		
		
		
		$(".cancel_campaign_changes").live('click',function(){
			$.fancybox.close();
		}); 
		...
		jQuery('.new_temp').click(function () {
			...
			//alert(jQuery(this).attr('data-tempalte'));
			jQuery.post('<?php echo base_url() ?>newsletter/campaign/fetchtemplate/<?php echo $campaign_id; ?>', postdata, function (result) {
				var response = jQuery.parseJSON(result);
				var campaign_id = response.campaign_id;
				window.location.href = '<?php echo base_url() ?>newsletter/campaign/responsivetemplate/<?php echo $campaign_id; ?>';
		   });
		});

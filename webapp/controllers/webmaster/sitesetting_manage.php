...
class Sitesetting_Manage extends CI_Controller
{
	...
	function cron_setting(){
		...
		'continue_campaign_send'=>$continue_campaign_send,
                                  'contact_analysis_cron_status'=>$contact_analysis_cron_status,
                                  'contact_analysis_cron_time'=>$contact_analysis_cron_time,
                                  'continue_bg_process_batch'=>$continue_bg_process_batch,
		'cronjob_status'=>$cronjob_status,
		'campaign_cron_status_change_time'=>$campaign_cron_status_change_time,
                                  'cronjob_status_2'=>$cronjob_status_2,
		'campaign_cron_status_change_time_2'=>$campaign_cron_status_change_time_2,
		'campaign_under_progress'=>$campaign_under_progress,
                                  'campaign_under_progress_2'=>$campaign_under_progress_2,

...
class Campaign extends CI_Controller
{
	...
	*/
	...
	//Fetch campaign data from database by campaign ID
		...
		$this->Campaign_Model->update_abtesting(array('is_delete'=>'1'),array('campaign_id'=>$id));		
		$this->Campaign_Model->update_abtesting(array('is_delete'=>'1'),array('ref_campaign_id'=>$id));
